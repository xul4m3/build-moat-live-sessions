...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--docs-dir", type=Path, required=True, help="Directory containing .md files to index"
    )
    parser.add_argument("--output", type=Path, required=True, help="Output path for index.json")
    ...
    if not sections:
        ...
        print(f"warning: no .md files found in {args.docs_dir}", file=sys.stderr)
        return 1
